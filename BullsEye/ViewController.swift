...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var roundLebel:UILabel!
    ...
    @IBAction func showAlert() {
        ...
        if difference == 0 {
           title = "Perfect!"
            ...
            if difference == 1 {   // co to za konstrukcja ifa ??
                points += 50
            }
        ...
        let alert = UIAlertController(title: title, message: message, preferredStyle: .alert) // 4 kroki do wytworzenia POP UP okienka
